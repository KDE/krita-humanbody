...
if(OPENCTL_DEFINITIONS AND OPENCTL_LIBRARIES)
  ...
  EXEC_PROGRAM(${PKGCONFIG_EXECUTABLE} ARGS --atleast-version=0.9.7 OpenCTL RETURN_VALUE _return_VALUE OUTPUT_VARIABLE _pkgconfigDevNull )

  if(_return_VALUE STREQUAL "0")
    set(OPENCTL_FOUND TRUE)
    set(HAVE_OPENCTL TRUE)
  else(_return_VALUE STREQUAL "0")
    message(STATUS "OpenCTL >= 0.9.7 was not found")
